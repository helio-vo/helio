...
<%@ taglib prefix="s" uri="/struts-tags" %>
    				 ...
    				 <table id="colTable" width="100%" border="0" cellspacing="1" cellpadding="0">
    				 		<TR height=20 class="PopupAltDataRow">
								...
								<td >&nbsp;&nbsp;&nbsp;<s:textfield id="timeConstraint" name="timeConstraint" cssClass="textfield" size="20" maxlength="20" value="" theme="simple"/></td>				
							</TR>
							<TR height=20 class="PopupAltDataRow">
								<TD nowrap class="txtblackBP" >Instrument Constraint:</TD>
								<td>&nbsp;&nbsp;&nbsp;<s:textfield id="instrumentConstraint" name="instrumentConstraint" cssClass="textfield" size="20" maxlength="100" value="" theme="simple"/></td>				
							</TR>
								<TR height=20 class="PopupAltDataRow">
								<TD nowrap class="txtblackBP" >Coordinate Constraint:</TD>
								<td>&nbsp;&nbsp;&nbsp;<s:textfield id="coordinateConstraint" name="coordinateConstraint" cssClass="textfield" size="20" maxlength="20" value="" theme="simple"/></td>				
							</TR>
					 		<%
						        int i=0;
						    %>
