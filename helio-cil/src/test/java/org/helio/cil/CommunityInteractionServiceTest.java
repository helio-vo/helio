package org.helio.cil;

import java.io.File;

import junit.framework.TestCase;

import org.helio.cil.common.LogUtilities;
import org.helio.hit.info.HIT;
import org.ietf.jgss.GSSException;

public class CommunityInteractionServiceTest extends TestCase 
{
	LogUtilities					logUtils	=	new LogUtilities();
	CommunityInteractionService		cis			=	null;
	
	public void testCommunityInteractionService() 
	{
...
//			cis.addUserWithSpecificProfile("user_b", "pwd_for_user_b", "profile_for_user_b");
	...
	public	void	testGetLowSecurityHITFor()
	{
		HIT		hit		=	null;
	...
	public	void	testGetLowSecurityHITForAnonymousUser()
	{
		HIT		hit		=	null;
	 ...
	 */
	public	void	testGetHighSecurityHITForAnonymousUser()
	{
		HIT		hit		=	null;
	 ...
	 * Skipped for now as it requires certificates
	 */
	public	void	testGetHighSecurityHITFor()
	{
		HIT		hit		=	null;
	...
	public	void	testSetUserProfileEntity()
	{
		testCommunityInteractionService();
