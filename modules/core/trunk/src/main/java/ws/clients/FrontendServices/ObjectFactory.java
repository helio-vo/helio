 ...
 * generated in the ws.clients.FrontendServices package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ws.clients.FrontendServices
     * 
     */
