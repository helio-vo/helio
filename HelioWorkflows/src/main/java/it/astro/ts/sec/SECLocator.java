...
public class SECLocator extends org.apache.axis.client.Service implements it.astro.ts.sec.SEC {
    ...
    public it.astro.ts.sec.SECPortType getSECwsdlPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.astro.ts.sec.SECBindingStub _stub = new it.astro.ts.sec.SECBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.astro.ts.sec.SECPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                it.astro.ts.sec.SECBindingStub _stub = new it.astro.ts.sec.SECBindingStub(new java.net.URL(SECwsdlPort_address), this);
                _stub.setPortName(getSECwsdlPortWSDDServiceName());
                return _stub;
            }
        }
