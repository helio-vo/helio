...
public class WorkflowResult {
    ...
    public WorkflowResult(int goes_id, String ntime_start, String time_start, String time_peak, String time_end, String ntime_end, int nar, float latitude, float longitude, float long_carr, String xray_class, String optical_class, String hessi_measurementStart, String hessi_measurementEnd, String hessi_flareNr, String hessi_measurementPeak, String hessi_peakCS, String hessi_totalCounts, String hessi_energyKeVFrom, String hessi_energyKeVTo, String hessi_xPos, String hessi_yPos, String hessi_radial, String hessi_AR, String phoenix2_measurementStart, String phoenix2_flareNr, String phoenix2_peakCS, String phoenix2_totalCounts, String phoenix2_energyKeVFrom, String phoenix2_energyKeVTo, String phoenix2_xPos, String phoenix2_yPos, String phoenix2_radial, String phoenix2_AR, String phoenix2_urlPhaseFITSGZ, String phoenix2_urlIntensityFITSGZ) {
 ...
 public WorkflowResult(Stack<String> rawData) {
        ...
        this.goes_id = Integer.parseInt(rawData.get(i++));
        this.ntime_start = rawData.get(i++);//789
        this.time_start = rawData.get(i++);
        ...
        System.out.println(i+" mi supernumero");
