                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: flareInstance, field: "phoenix2_urlPhaseFITSGZ")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: flareInstance, field: "phoenix2_urlIntensityFITSGZ")}</td>
