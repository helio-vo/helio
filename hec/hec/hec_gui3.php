<?php
  ...
  echo '<b>Recent Changes</b>&#160;<a href="http://helio-cdaws.blogspot.com/search/label/HEC" target="hio_blog"><img src="blogspot-favicon_sm.jpg" title="CDAW Blog topic on the HEC" border=0  alt=""></a>';
...
//  echo '<tr><img src="info_icon.gif" onmouseover="InfoMouseOver(\'timetitleid\',\'Specify event time span for searching catalogues\')" onmouseout="InfoMouseOut(\'timetitleid\',\'Search time interval\')" </tr>';
  echo '&#160;<img src="info_icon.gif" title="Specify event time span for searching catalogues" border=0 style="font-style:italic;" alt="">';
  echo '</td>';
  ...
  echo '&#160;&#160;&#160;To&#160;';
  sec_date("to",FALSE);
  echo '&#160;&#160;&#160;&#160;<a href="hec.png" target="_blank"><img src="hec.png" align="middle" title="Catalogue time coverage" width=60 height=60 alt=""></a>';
  echo '</td></tr>';
...
//  echo '<P>';
  ...
  echo '&#160;<img src="info_icon.gif" title="Specify event characteristics to restrict search" border=0 style="font-style:italic;" alt="">&#160;&#160;';
  echo '</td>';
...
*/
    ...
    echo '<b>Catalogues matching selection</b>';
    echo '&#160;<img src="info_icon.gif" title="Select catalogues to get events from and fetch data" border=0 style="font-style:italic;" alt="">';
//    echo '</td>';
    echo '&#160;&#160;&#160;<INPUT TYPE="button" style="background-color:lightgreen; color:black;" value="Submit search" onclick="document.forms[\'catform\'].submit();">';
    echo '<br><br>';
