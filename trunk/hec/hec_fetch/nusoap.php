...
/*
$Id: nusoap.php,v 1.67 2004/01/29 05:04:34 snichol Exp $
...
* @version  $Id: nusoap.php,v 1.67 2004/01/29 05:04:34 snichol Exp $
* @access   public
*/
class nusoap_base {
...
* @access   public
*/
class soapclientnu extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclientnu($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
	...
	*/
	function getProxy(){
		...
		$r = rand();
		$evalStr = 'class soap_proxy_'.$r.' extends soapclientnu {
				'.$evalStr.'
			}';
