...
//	  $s = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"        "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">      <html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">';
		$s .= "<html>";
		...
		$s .= '<center>';
		$s .= '<table><tr>';
		$s .= '<td><a href="http://www.helio-vo.eu"><img src="helio_logo.gif" border=0 alt=""></a></td>';
		$s .= '<td><font size="+3" color="red"><b>Heliophysics Event Catalogue</b></font></td>';
    $s .= '<td><a href="http://ec.europa.eu/research/fp7/index_en.cfm?pg=capacities"><img src="FP7-cap-RGB12.gif" border=0  width="95%" alt=""></a></td>';
		$s .= '</tr></table></center><hr>'."\n";
		return $s;
	}
