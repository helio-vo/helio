<?php
	# =============================================
	# EGSO 2003-2005 SEC server - by Andrej Santin
...
//	$tempdir = "/var/www/html/sec/temp/hef";
...
//    $curyearDirectory = "flares." . $curyear . ".*";

//	$list = ftp_nlist($conn, "flares.*.*");
//	$list = ftp_nlist($conn, "flares.2013.*");
//	$list = ftp_nlist($conn, "flares.2014.*");
//	$list = ftp_nlist($conn, $curyearDirectory);
	$list = ftp_nlist($conn, "flares.2015.*");

var_dump($list);
        echo count($list);
 echo "\n";
        echo count($list, COUNT_RECURSIVE); // output 8
