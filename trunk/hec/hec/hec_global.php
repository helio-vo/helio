 <?php
	...
	function hec_header($title) {
		...
		$s .= '<link rel=stylesheet HREF="hec.css" TYPE="text/css">';
...
the HEC contains event catalogues from many domains that are frequently updated">'."\n";
	...
	function sec_footer() {
		...
		//old -- $s .= '<td><a href="http://mon.itor.us/sharedPage.jsp?tI=pSRAmMcPtFVOPGEFPAqWFA%253D%253D&uI=KUNt4SiMVMLh1gDedD7TLQ%253D%253D" target="_blank">mon.itor.us/Tools</a></td>';
