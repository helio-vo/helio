...
//    desc("xxx");//document.getElementByName("y_from").value);
  ...
  function hoverover(e,id) {
    ...
    //alert("posx="+posx+" posy="+posy);
     document.getElementById(id).style.left=posx+10;
  ...
  function hoverout(e,id) {
    document.getElementById(id).style.visibility = 'hidden';
    //document.getElementById(id).display = 'hidden';
    //alert("out");
  }//hoverout

  function setTimeto() {
    var y_from = document.getElementsByName("y_from")[0].value;
    var mo_from = document.getElementsByName("mo_from")[0].value;
    var d_from = document.getElementsByName("d_from")[0].value;
    //alert(x[0].value);
    var today = new Date(y_from,mo_from-1,d_from,0,0,0);
//    document.getElementsByName("y_to")[0].value = (today.getYear()+1900);
//    document.getElementsByName("mo_to")[0].value = (today.getMonth()+1);
//    document.getElementsByName("d_to")[0].value = today.getDate();

    //alert(today.getYear()+" "+(today.getMonth()+1)+" "+today.getDate()+"=");

    var y_to = document.getElementsByName("y_to")[0].value;
    var mo_to = document.getElementsByName("mo_to")[0].value;
    var d_to = document.getElementsByName("d_to")[0].value;

    var date_from = new Date(y_from,mo_from,d_from,0,0,0);
    var date_to = new Date(y_to,mo_to,d_to,0,0,0);
    if (date_from>date_to) {
      document.getElementsByName("y_to")[0].style.color = "red";
      document.getElementsByName("mo_to")[0].style.color = "red";
      document.getElementsByName("d_to")[0].style.color = "red";
    } else 
{
      document.getElementsByName("y_to")[0].style.color = "black";
      document.getElementsByName("mo_to")[0].style.color = "black";
      document.getElementsByName("d_to")[0].style.color = "black";
    }
  }//setTimeto
